...
<body id='top' >
	...
	<div class="wrap_fullwidth" id='head'>
   	...
   	<div class='center'>
		<h1>Universal Digital Library System</h1>
			<ul id="nav">
				<li><a href="index_fadeslide.html">Home</a></li>
				<li><a href="book.php">Books</a></li>
				<li  class='current'><a href="">Sign In</a>
                <ul>
	...
	<div class="wrap_fullwidth" id='feature_background'>	
		...
		<!-- ###################################################################### -->
            ...
            User Id &nbsp&nbsp&nbsp&nbsp<input type="text" name="userid" value="" />
            <br/>
...
$id=$_POST["userid"];
$pwd=$_POST["password"];
$sqlr=mysql_query("select * from passwords where person_id='$id' and password='$pwd' ");

$row=mysql_num_rows($sqlr);
if ($row==1)
  {
	  $_SESSION['userid'] = $id;
   header("Location:http://localhost/elementia/elementia/water/librarian_book.php");
  }
else
{

	  header("Location:http://localhost/elementia/elementia/water/index_fadeslide.html");
}
